		...
		<div className="max-w-7xl mx-auto p-4 md:p-6 text-black">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				<div className="space-y-6">
					...
					<section className="bg-linear-to-br from-blue-50 to-indigo-50 rounded-xl p-5">
							...
							{dailyRatings.map((day, idx) => {
								...
								return (
									...
									>
										...
										{!hasData && (
											<div className="absolute top-1/2 -translate-y-1/2 w-full h-0.5 bg-gray-200 rounded-sm" />
										)}
										{isToday && (
