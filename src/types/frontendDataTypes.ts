...
export const sortConfig = {
	...
	Aktiviteter: [{ prop: 'name', name: 'Navn' }, { prop: 'createdAt', name: 'Oprettet' }, { prop: 'updatedAt', name: 'Opdateret' }],
	Rum: [{ prop: 'name', name: 'Navn' }, { prop: 'createdAt', name: 'Oprettet' }, { prop: 'updatedAt', name: 'Opdateret' }, { prop: 'description', name: 'Beskrivelse' }],
	Kiosker: [{ prop: 'name', name: 'Navn' }, { prop: 'createdAt', name: 'Oprettet' }, { prop: 'updatedAt', name: 'Opdateret' }, { prop: 'kioskTag', name: 'Kiosk Tag' }, { prop: 'readerId', name: 'Reader ID' }],
